...
* `name` - (Optional) Name of the Auto Scaling Group. By default generated by the provider. Conflicts with `name_prefix`.
...
~> **NOTE:** The provider has two types of ways you can add lifecycle hooks - via
