...
// The identifier is the bucket name.
func BucketUpdateTags(ctx context.Context, conn *s3.S3, identifier string, oldTagsMap interface{},
	newTagsMap interface{}) error {
...
func ObjectUpdateTags(ctx context.Context, conn *s3.S3, bucket, key string, oldTagsMap interface{},
	newTagsMap interface{}) error {
	oldTags := tftags.New(oldTagsMap)
	newTags := tftags.New(newTagsMap)
